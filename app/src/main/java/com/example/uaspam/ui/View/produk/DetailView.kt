package com.example.uaspam.ui.View.produk
...
import com.example.uaspam.ui.ViewModel.produk.DetailUiState
...
fun ItemDetailprdk(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailMhs(
                judul = "ID PRODUK",
                isinya = produk.id_produk.toString()
            )
            ComponentDetailMhs(
                judul = "NAMA PRODUK", isinya = produk.nama_produk
            )
            ComponentDetailMhs(
                judul = "DESKRIPSI", isinya = produk.deskripsi_produk
            )
            ComponentDetailMhs(
                judul = "HARGA", isinya = produk.harga.toString()
            )
            ComponentDetailMhs(
                judul = "STOK", isinya = produk.stok.toString()
            )
            ComponentDetailMhs(
                judul = "ID KATEGORI", isinya = produk.id_kategori.toString()
            )
            ComponentDetailMhs(
                judul = "ID PEMASOK", isinya = produk.id_pemasok.toString()
            )
            ComponentDetailMhs(
                judul = "ID MEREK", isinya = produk.id_merk.toString()
            )
