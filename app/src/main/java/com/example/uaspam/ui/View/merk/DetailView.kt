package com.example.uaspam.ui.View.merk
...
import com.example.uaspam.ui.ViewModel.merk.DetailUiStateMerk
...
fun ItemDetailmrk(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailMrk(judul = "ID MEREK", isinya = merk.id_merk.toString())
            ComponentDetailMrk(judul = "NAMA MEREK", isinya = merk.nama_merk)
            ComponentDetailMrk(judul = "DESKRIPSI", isinya = merk.deskripsi_merk)
