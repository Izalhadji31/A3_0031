package com.example.uaspam.ui.View.pemasok
...
import com.example.uaspam.ui.ViewModel.pemasok.DetailUiStatePemasok
...
fun ItemDetailpmsk(
    ...
    Card(
        ...
        Column(
            ...
            ComponentDetailPmsk(
                judul = "ID PEMASOK",
                isinya = pemasok.id_pemasok.toString()
            )
            ComponentDetailPmsk(
                judul = "NAMA PRODUK",
                isinya = pemasok.nama_produk
            )
            ComponentDetailPmsk(
                judul = "NAMA PEMASOK",
                isinya = pemasok.nama_pemasok
            )
            ComponentDetailPmsk(
                judul = "ALAMAT",
                isinya = pemasok.alamat_pemasok
            )
            ComponentDetailPmsk(
                judul = "TELEPON",
                isinya = pemasok.telepon_pemasok.toString()
            )
