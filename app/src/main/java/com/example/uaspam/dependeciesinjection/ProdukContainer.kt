...
class ProdukContainer : AppContainer {
    ...
    private val baseUrlproduk = "http://10.0.2.2/dataTK/produk/"
    private val baseUrlpemasok = "http://10.0.2.2/dataTK/pemasok/"
    private val baseUrlkategori = "http://10.0.2.2/dataTK/kategori/"
    private val baseUrlmerk = "http://10.0.2.2/dataTK/merk/"
